...
export default function ImageGallery2() {
  ...
  return (
    <div className="Container mb-6 lg:mb-8 flex flex-col lg:flex-row w-full gap-4">
      ...
      {footerBanner1 ? (
        <a
          href={footerBanner1.link || '#'}
          target="_blank"
          rel="noopener noreferrer"
          className="h-48 w-full lg:w-8/12 relative overflow-hidden rounded-lg shadow hover:shadow-md transition-shadow block"
        >
          <img
      ...
      {footerBanner2 ? (
        <a
          href={footerBanner2.link || '#'}
          target="_blank"
          rel="noopener noreferrer"
          className="h-48 w-full lg:w-4/12 relative overflow-hidden rounded-lg shadow hover:shadow-md transition-shadow block"
        >
          <img
